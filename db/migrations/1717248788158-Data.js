module.exports = class Data1717248788158 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "factory" ("id" character varying NOT NULL, "market_count" integer NOT NULL, "total_volume_usd" numeric NOT NULL, "total_liquidity_usd" numeric NOT NULL, CONSTRAINT "PK_1372e5a7d114a3fa80736ba66bb" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "factory_day_data" ("id" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "daily_volume_usd" numeric NOT NULL, "total_volume_usd" numeric NOT NULL, "total_liquidity_usd" numeric NOT NULL, CONSTRAINT "PK_4b56c54390ce8e399d8e37e169d" PRIMARY KEY ("id"))`)
